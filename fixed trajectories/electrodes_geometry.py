...
# object1 = one_sheet_hyperboloid(0.2, 1, 2, 0.5)
object1 = one_sheet_hyperboloid(0.15, 1, 2, 0.5)
#plot_mesh(object1, 'One-sheet hyperboloid')

# object2 = two_sheets_hyperboloid(2.0, np.array([0, 0, 0]), 300, 10, 0.5)
object2 = two_sheets_hyperboloid(2.0, np.array([0, 0, 0]), 500, 10, 0.5)
#plot_mesh(object2, 'Two-sheets hyperboloid')

# object3 = two_sheets_hyperboloid2(2.0, np.array([0, 0, 0]), 300, 10, 0.5)
object3 = two_sheets_hyperboloid2(2.0, np.array([0, 0, 0]), 500, 10, 0.5)
