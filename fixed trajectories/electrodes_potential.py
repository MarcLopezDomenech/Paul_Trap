...
xslice = mlab.volume_slice(X, Y, Z, V, plane_orientation='x_axes', colormap='jet', slice_index = 25)
yslice = mlab.volume_slice(X, Y, Z, V, plane_orientation='y_axes', colormap='jet', slice_index = 25)
zslice = mlab.volume_slice(X, Y ,Z, V, plane_orientation='z_axes', colormap='jet', slice_index = 25)
...
coneplot = mlab.quiver3d(Xd, Yd, Zd, Ex, Ey, Ez, colormap='jet', mode='cone')
mlab.title('Potential')
axes = mlab.axes()
mlab.show()

fig2 = mlab.figure()
contours = mlab.contour3d(X, Y, Z, V, colormap='jet')
coneplot = mlab.quiver3d(Xd, Yd, Zd, Ex, Ey, Ez, colormap='jet', mode='cone')
mlab.title('Potential')
axes = mlab.axes()
mlab.show()
