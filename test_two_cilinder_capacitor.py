...
if __name__ == '__main__':
    ...
    plt.plot(N_all, E_all, '.--', label='Error absolut')
    plt.legend()
    plt.show()
    plt.plot(N_all, r_all, '.--', label='Error relatiu')
    plt.legend()
    plt.show()
    plt.plot(N_all, QE_all, '.--', label='Quocient error absolut amb error 2N')
    plt.plot(N_all, Qr_all, '.--', label='Quocient error relatiu amb error 2N')
    plt.legend()
    plt.show()
